    ...
    <div class="lg:pl-64 flex flex-col">
        <main class="flex-1">
            <div class="hidden mt-8 sm:block">
                <form action="{{route('add-event')}}" method="post" enctype="multipart/form-data" class="max-w-screen-sm mx-auto">
                    @csrf
                    <span class="text-center items-center text-gray-700 text-xl">Add New New Event</span>
                    <div class="flex justify-center items-center text-center w-full py-6">
                        <div class="block w-full space-y-6">
                            ...
                            <div class=" w-full border-b border-indigo-600">
                                <input type="text" name="event_link" class="w-full rounded-md border border-gray-300 hover:border-indigo-700" placeholder="Event Link">
                            </div>
                            ...
                            <div class="hover:bg-indigo-500">
                                <button class="w-full py-6 rounded-lg bg-indigo-600 text-white hove:bg-indigo-300">Add New Event</button>
                            </div>
                        </div>
                    </div>
                </form>

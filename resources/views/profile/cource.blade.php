    ...
    <div class="lg:pl-64 flex flex-col">
        <main class="flex-1">
            <div class="hidden mt-8 sm:block">
                <form action="{{route('add-course')}}" method="post" enctype="multipart/form-data" class="max-w-screen-sm mx-auto">
                    @csrf
                    ...
                    <div class="flex justify-center items-center text-center w-full py-6">
                        <div class="block w-full space-y-6">
                            ...
                            <div class=" w-full border-b border-indigo-600">
                                <input type="number" name="price" class="w-full rounded-md border border-gray-300 hover:border-indigo-700" placeholder="Price">
                            </div>
                            <div class=" w-full border-b border-indigo-600">
                            ...
                            <div class="w-full border-b border-indigo-600">
                                <input type="text" name="sessions" class="w-full outline-0 border-gray-300 hover:border-indigo-700" placeholder="Session">
                            </div>
                            <!--Start-->
                            ...
                            <div class="w-full space-y-4 hidden" id="core-description">
                                <div class="w-full border-b border-indigo-600">
                                    <input type="text" name="week" class="w-full rounded-md border border-gray-300 hover:border-indigo-700" placeholder="Week">
                                </div>
                                <div class="w-full border-b border-indigo-600">
                                ...
                                <div class="w-full border-b border-indigo-600">
                                    <input type="text" name="duration" class="w-full rounded-md border border-gray-300 hover:border-indigo-700" placeholder="Duration">
                                </div>
                            </div>
